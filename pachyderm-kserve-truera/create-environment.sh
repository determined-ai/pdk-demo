...
gcloud container clusters create ${CLUSTER_NAME} \
	--project ${PROJECT_ID} \
	--zone ${GCP_ZONE} \
	--network "projects/${PROJECT_ID}/global/networks/primary" \
	--subnetwork "projects/${PROJECT_ID}/regions/us-central1/subnetworks/primary" \
	...
	--master-ipv4-cidr "10.10.10.0/28" \
